...
public:
  ...
  TTree *signal;     //! pointer to the analyzed TTree for signal
  TTree *background; //! pointer to the analyzed TTree for signal
  ...
  TH1F *histo_signal[8], *histo_background[8], *sig_bkg_eff;
