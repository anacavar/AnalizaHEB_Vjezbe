...
void Analyzer::Loop()
{
  ...
  if (histo_background[0]->GetMaximum() > histo_signal[0]->GetMaximum())
    histo_signal[0]->SetMaximum(1.3 * histo_background[0]->GetMaximum());
  ...
  if (histo_background[1]->GetMaximum() > histo_signal[1]->GetMaximum())
    histo_signal[1]->SetMaximum(1.3 * histo_background[1]->GetMaximum());
  ...
  if (histo_background[2]->GetMaximum() > histo_signal[2]->GetMaximum())
    histo_signal[2]->SetMaximum(1.3 * histo_background[2]->GetMaximum());
  ...
  if (histo_background[3]->GetMaximum() > histo_signal[3]->GetMaximum())
    histo_signal[3]->SetMaximum(1.3 * histo_background[3]->GetMaximum());
  ...
  if (histo_background[4]->GetMaximum() > histo_signal[4]->GetMaximum())
    histo_signal[4]->SetMaximum(1.3 * histo_background[4]->GetMaximum());
  ...
  if (histo_background[5]->GetMaximum() > histo_signal[5]->GetMaximum())
    histo_signal[5]->SetMaximum(1.3 * histo_background[5]->GetMaximum());
  ...
  if (histo_background[6]->GetMaximum() > histo_signal[6]->GetMaximum())
    histo_signal[6]->SetMaximum(1.3 * histo_background[6]->GetMaximum());
  ...
  if (histo_background[7]->GetMaximum() > histo_signal[7]->GetMaximum())
    histo_signal[7]->SetMaximum(1.3 * histo_background[7]->GetMaximum());
